				...
				<form class="layui-form layui-form-pane" action="#" lay-filter="component-form-article-edit">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							...
							<input lay-verify="required" id="image_name" placeholder="图片地址" value="" class="layui-input">
						</div>
						...
						<div class="layui-inline">
							<label class="layui-form-label required">置顶</label>
							<div class="layui-input-block">
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-block">
								<input type="text" name="releaseDate" id="LAY-component-form-group-date" lay-verify="datetime" value="${article.releaseDate}" placeholder="" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-inline">
							<label class="layui-form-label">发布状态</label>
							<div class="layui-input-inline">
							    <input type="checkbox" name="status" lay-skin="switch"  value="${article.switch}" lay-text="发布|不发布">
							</div>
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-input-block">
							<button class="layui-btn" lay-submit lay-filter="component-form-article-edit"><i class="fa fa-check"></i>确认保存</button>
