				...
				<form class="layui-form layui-form-pane" action="#" lay-filter="component-form-article-edit">
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-block">
								<input type="text" name="releaseDate" id="LAY-component-form-group-date" lay-verify="datetime" placeholder="" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-inline">
							<label class="layui-form-label">发布状态</label>
							<div class="layui-input-inline">
							    <input type="checkbox" name="status" lay-skin="switch" lay-text="发布|不发布">
							</div>
						</div>
					</div>
					<div class="layui-form-item">
