...
layui.use(['form','jquery',"layer"],function() {
    ...
    if(window.sessionStorage.getItem('userFace') &&  $(".userAvatar").length > 0){
        ...
        $("#userFace").attr("src","/wxl/admin/sys/storge/showImage/admin/user/38e4e03a971d418eb4289194534168d0");
    }
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-time" id="lockTime"><h2>' + new Date().Format("yyyy-MM-dd hh:mm:ss")  + '</h2></div>'+
                            '<div class="admin-header-lock-img"><img src="' + $(".userAvatar").attr("src") + '" class="userAvatar"/></div>'+
                            '<div class="admin-header-lock-name" id="lockUserName">'  + $(".adminName").html() + '</div>'+
                            '<div class="input_btn">'+
...
function getTime(){
		$("#lockTime").html("<h2>" + new Date().Format("yyyy-MM-dd hh:mm:ss") + "</h2>"); //将值赋给div
	}