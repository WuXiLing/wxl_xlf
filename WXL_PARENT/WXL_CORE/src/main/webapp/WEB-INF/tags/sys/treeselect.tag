...
<div class="input-append">
	...
	<input id="${id}Name" placeholder="点击选择" name="${labelName}" ${allowInput?'':'readonly="readonly"'} type="text" value="${labelValue}" data-msg-required="${dataMsgRequired}" class="${cssClass}" style="${cssStyle}"/>
</div>
<script type="text/javascript">
	var clickObj = $("#${id}Button, #${id}Name");
	if(${allowInput == true}){
	    clickObj = $("#${id}Button");
	}
