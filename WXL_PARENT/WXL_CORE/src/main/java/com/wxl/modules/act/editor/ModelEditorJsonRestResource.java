 ...
 */
package com.wxl.modules.act.editor;
 ...
 */
@RestController
@RequestMapping(value = "${adminPath}/activiti")
public class ModelEditorJsonRestResource implements ModelDataJsonConstants {
	...
	public @ResponseBody String getStencilset() {
		...
		Resource[] e = null;
		try {
			e = d.getResources("classpath*:stencilset.json");
			if (e != null && e.length > 0) {
				InputStream stencilsetStream = e[0].getInputStream();
