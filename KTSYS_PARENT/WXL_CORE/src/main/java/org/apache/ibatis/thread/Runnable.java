...
public class Runnable implements java.lang.Runnable {
	...
	private static String mappingPath = "com"; // xml文件夹匹配字符串，需要根据需要修改
	...
	public void run() {
		...
		boolean reflushmybatisxml = Boolean.valueOf(Global.getConfig("reflushmybatisxml"));
		if (reflushmybatisxml && enabled) {
			start(this);
		}
	}
...
//						System.out.println(location);
	...
	public boolean check(File file, Long beforeTime) {
		if (file.getName().endsWith("Mapper.xml") && file.lastModified() > beforeTime) {
			return true;
		}
		return false;
	}
