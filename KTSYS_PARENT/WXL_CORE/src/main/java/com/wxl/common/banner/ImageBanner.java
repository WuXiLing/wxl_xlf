...
import com.wxl.common.banner.ansi.AnsiBackground;
import com.wxl.common.banner.ansi.AnsiColor;
import com.wxl.common.banner.ansi.AnsiColors;
import com.wxl.common.banner.ansi.AnsiElement;
...
public class ImageBanner implements Banner {
	...
	private void printBanner(PrintStream out) throws IOException {
		// PropertiesLoader properties = new PropertiesLoader("banner.image.");
		...
		// boolean invert = properties.getProperty("invert", Boolean.class,
		// false);
		// BufferedImage image = readImage(width, height);
		// printBanner(image, margin, invert, out);
	}

	public BufferedImage readImage(int width, int height) throws IOException {
	...
	public void printBanner(BufferedImage image, int margin, boolean invert, PrintStream out) {
