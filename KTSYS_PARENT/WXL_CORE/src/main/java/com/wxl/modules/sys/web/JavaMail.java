...
public class JavaMail {
    ...
    private static PropertiesLoader loader = new PropertiesLoader("mailServer.properties");
    ...
    public static synchronized JavaMail getInstance(){
    	if(javaMail==null){
    		return new JavaMail(false);
    	}
    	return javaMail;
    }
    /*
     * 初始化方法
     */
    private JavaMail(boolean debug) {
    ...
    public boolean anysSendEmai(final String subject, final String sendHtml,
    ...
    public static void main(String[] args) {
        ...
        se.anysSendEmai("邮件主题", "邮件内容", "406052782@qq.com");
        System.out.println("是不是异步");
    }
}