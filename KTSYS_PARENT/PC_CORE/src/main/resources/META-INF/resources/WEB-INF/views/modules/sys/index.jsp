...
<head>
	...
	<link rel="icon" href="${ctxStatic}/images/favicon/xgd/16/favicon.ico" type="image/x-icon" />
	<link rel="shortcut icon" href="${ctxStatic}/images/favicon/xgd/16/favicon.ico" type="image/x-icon" />
			...
			<div class="layui-main mag0">
				...
				<ul class="layui-nav topLevelMenus" pc>
					...
					<li class="layui-nav-item" data-menu="-1" pc>
					    <a href="${ctxf}" target="_blank"><i class="fa fa-fa-rocket"></i><cite>网站首页</cite></a>
					</li>
				</ul>
			    <!-- 顶部右侧菜单 -->
