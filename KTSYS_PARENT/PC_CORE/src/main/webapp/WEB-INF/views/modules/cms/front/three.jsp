...
<body>
	...
	<div class="layui-fluid">
		    ...
		    <div class="layui-col-md12">
		        <div class="crumb">
		            <c:if test="${columns.type eq '389e1a7f28ef4500bb68d9dba14207d4'}">
			            <i class="fa fa-home"></i>&nbsp;&nbsp;当前位置：<a href='${ctxf}' target="_blank">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href='${ctxf}/columnsThree/${columns.id}' style="color: #5886e8;" target="_blank">${columns.name}</a>
		            </c:if>
		             <c:if test="${columns.type ne '389e1a7f28ef4500bb68d9dba14207d4'}">
			            <i class="fa fa-home"></i>&nbsp;&nbsp;当前位置：<a href='${ctxf}' target="_blank">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href='${ctxf}/senond/${columns.id}' style="color: #5886e8;" target="_blank">${columns.name}</a>
		            </c:if>
		        </div>
		    </div>
		</div>
		...
		<c:if test="${not empty article or article.showTitle ne '1'}">
		   <c:if test="${article.showTitle ne '1'}">
	...
	<script type="text/javascript">
		layui.use([ 'table' ], function() {
			...
			$.get(ctxf + "/article/${id}",function(res){
